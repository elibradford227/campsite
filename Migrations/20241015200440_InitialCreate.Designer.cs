...
namespace CreekRiver.Migrations
{
    ...
    [Migration("20241015200440_InitialCreate")]
            ...
            modelBuilder.Entity("CreekRiver.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CampsiteId = 1,
                            CheckinDate = new DateTime(2024, 10, 15, 15, 4, 40, 214, DateTimeKind.Local).AddTicks(9185),
                            CheckoutDate = new DateTime(2024, 10, 17, 15, 4, 40, 214, DateTimeKind.Local).AddTicks(9212),
                            UserProfileId = 1
                        });
                });
